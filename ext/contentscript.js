...
$(".magiw-dropdown").on('click', function(){
    ...
    .done(function(data) {
      ...
      if (data.result) {
        ...
        if (data.result.wordAudioUS){
          $('.audio-file-US').attr('href', data.result.wordAudioUS).show();
        }
        if (data.result.wordAudioUS){
          $('.audio-file-GB').attr('href', data.result.wordAudioGB).show();
        }
